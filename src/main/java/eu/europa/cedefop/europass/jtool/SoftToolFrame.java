...
/**
   ...
   */     
    void fileConfiguration_ActionPerformed(ActionEvent e) {
         SoftToolFrame_Config confPanel = new SoftToolFrame_Config( );
         String logs = null;                  
         int option = JOptionPane.showOptionDialog(this, 
                                              confPanel, 
                                              "Configuration", 
         ...
         switch(option) {
             case 0: // SAVE INTO SOFTTOOL.PROPERTIES
                     this.statusBar.setText( "Saving data..." );                     
                     logs = SoftToolUtil.saveConfig(confPanel.getFldDatabasename(), 
                                                    confPanel.getFldPassword(),
                                                    confPanel.getFldURL(),
                                                    confPanel.getFldUsername(),
                                                    confPanel.getSqlServer(),
                                                    confPanel.getMySQL(),
                                                    confPanel.getOracle()
                                                    );
                     this.statusBar.setText( logs );
