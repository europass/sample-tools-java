...
CREATE TABLE [dbo].[ecv_education] (
	[id] [numeric](18, 0) IDENTITY (1, 1) NOT NULL ,
	[xml_id] [numeric](18, 0) NULL ,
	[title] [varchar] (200) COLLATE Greek_CS_AS NULL ,
...
CREATE TABLE [dbo].[ecv_work_experience] (
	...
	[employer_name] [varchar] (100) COLLATE Greek_CS_AS NULL ,
	[employer_address] [varchar] (100) COLLATE Greek_CS_AS NULL ,
...
CREATE TABLE [dbo].[ecv_xml] (
	...
	[phone2] [varchar] (30) COLLATE Greek_CS_AS NULL ,
	[phone3] [varchar] (30) COLLATE Greek_CS_AS NULL ,
	...
	[code_application] [varchar] (50) COLLATE Greek_CS_AS NULL ,
	[application] [varchar] (1024) COLLATE Greek_CS_AS NULL ,
	...
	[job_related] [ntext] COLLATE Greek_CS_AS NULL ,
